...
// Light scheme = the authentication design handoff's Material 3 palette (Theme.dc.html).
// primary = coral, secondary = sky, tertiary = green, surfaces = the SignIn "sky" tint set.
// Only the auth screens render with useDarkTheme = false; the rest of the app uses darkScheme.
val primaryLight = Color(0xFFFF6B3D)
val onPrimaryLight = Color(0xFFFFFFFF)
val primaryContainerLight = Color(0xFFFFDBCE)
val onPrimaryContainerLight = Color(0xFF7A2A0C)
val secondaryLight = Color(0xFF00A0C4)
val onSecondaryLight = Color(0xFFFFFFFF)
val secondaryContainerLight = Color(0xFFC2EDF8)
val onSecondaryContainerLight = Color(0xFF00404E)
val tertiaryLight = Color(0xFF43A047)
val onTertiaryLight = Color(0xFFFFFFFF)
val tertiaryContainerLight = Color(0xFFC8F0C9)
val onTertiaryContainerLight = Color(0xFF274D28)
val errorLight = Color(0xFFBA1A1A)
val onErrorLight = Color(0xFFFFFFFF)
val errorContainerLight = Color(0xFFFFDAD6)
val onErrorContainerLight = Color(0xFF93000A)
val backgroundLight = Color(0xFFFFFFFF)
val onBackgroundLight = Color(0xFF06425E)
val surfaceLight = Color(0xFFFFFFFF)
val onSurfaceLight = Color(0xFF06425E)
val surfaceVariantLight = Color(0xFFF4FBFD)
val onSurfaceVariantLight = Color(0xFF5E8FA3)
val outlineLight = Color(0xFF8FB8C7)
val outlineVariantLight = Color(0xFFD9EEF5)
...
val surfaceDimLight = Color(0xFFDDEBEF)
val surfaceBrightLight = Color(0xFFFFFFFF)
val surfaceContainerLowestLight = Color(0xFFFFFFFF)
val surfaceContainerLowLight = Color(0xFFF4FBFD)
val surfaceContainerLight = Color(0xFFF4FBFD)
val surfaceContainerHighLight = Color(0xFFEDF6F9)
val surfaceContainerHighestLight = Color(0xFFE4F1F6)
