...
private inline val ThrottleConfiguration.isLeading: Boolean
  get() = this === ThrottleConfiguration.LEADING || this === ThrottleConfiguration.LEADING_AND_TRAILING

private inline val ThrottleConfiguration.isTrailing: Boolean
  get() = this === ThrottleConfiguration.TRAILING || this === ThrottleConfiguration.LEADING_AND_TRAILING
...
public fun <T> Flow<T>.throttleTime(
  duration: Duration,
  throttleConfiguration: ThrottleConfiguration = ThrottleConfiguration.LEADING,
