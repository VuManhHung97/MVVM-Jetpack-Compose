...
@file:Suppress("UNCHECKED_CAST", "ReplaceManualRangeWithIndicesCalls", "MagicNumber")
...
internal fun <State, Result> Flow<State>.select1Internal(selector: suspend (State) -> Result): Flow<Result> = flow {
